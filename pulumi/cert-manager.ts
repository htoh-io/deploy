...
export class CertManagerComponent extends pulumi.ComponentResource {
    ...
    constructor(
        ...
        // this.manager = new certmanager.CertManager("cert-manager", {
        //     installCRDs: true,
        //     helmOptions: {
        ...
        //     }
        // })
        this.secret = new k8s.apiextensions.CustomResource("azuredns-config", {
        ...
        // this.clusterIssuer = new k8s.apiextensions.CustomResource("letsencrypt", {
        ...
        //     }
        // }, {
        //     dependsOn: [this.manager, this.secret]
        // })
    }
}